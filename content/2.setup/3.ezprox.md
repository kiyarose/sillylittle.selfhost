...
::alert{type="info"}
:icon{name="flat-color-icons:idea"} | This documentation is for setting up https://prox2.sillylittle.tech on your own domain/setup, visit the URL for the publically hosted version, and append your URL to use it (eg. https://prox2.sillylittle.tech/https://www.example.com)
::
...
Check out https://docs2.sillylittle.tech/setup/acprox for an example of a working setup. \
...
::alert{type="warning"}
:icon{name="flat-color-icons:high-priority"} PLEASE NOTE: In the UV config the bare server is @ https://go2.sillylittle.tech/bare/ (an external resource, hosted by me).\
